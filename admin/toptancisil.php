...
$toptanci = $db->prepare("DELETE FROM toptancilar WHERE id='$id'");
$toptanci->execute();
...
<html lang="tr">
  <head>
    ...
    <title>Toptancı Sil | UVM Toptancılık</title>
    <script>
    function cikisonay() {
...
<form method="post" action="">
  <div class="form-group">
    <label for="exampleInputPassword1"><?php echo $ad ?> toptancısını silmek istediğinize emin misiniz?</label>
  </div>
