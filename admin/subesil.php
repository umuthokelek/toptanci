...
$sube = $db->prepare("DELETE FROM subeler WHERE id='$id'");
$sube->execute();
...
<html lang="tr">
  <head>
    ...
    <title>Şube Sil | UVM Toptancılık</title>
...
<form method="post" action="">
  <div class="form-group">
    <label for="exampleInputPassword1"><?php echo $ad ?> şubesini silmek istediğinize emin misiniz?</label>
  </div>
