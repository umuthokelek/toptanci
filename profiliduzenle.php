...
<html lang="tr">
  <head>
    ...
    <title>Şube Profili Düzenle | UVM Toptancılık</title>
  ...
  <div class="pull-right">Hoş geldin, <?php echo $_SESSION["subead"] ?>.</div><br>
...
<form name="profilform" method="post" action="">
